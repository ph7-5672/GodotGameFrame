...
namespace Frame.Common
{
    public static class UtilityType
    {
        ...
        {
            var methodInvoker = GetMethodInvoker(methodInfo);
            return methodInvoker(instance, args);
        }


        public delegate object FastInvokeHandler(object target, object[] args);

        static object InvokeMethod(FastInvokeHandler invoke, object target, params object[] args)
        {
